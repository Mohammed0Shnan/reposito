...
class AuthService {
  ...
  Future<bool> loginUser( String uid, String password, String email, USER_TYPE role, AUTH_SOURCE authSource, ) async {
  ...
  Future<String> loginFireStore(String email, String password,bool islogin) async {
    var user;
    try{
      if(islogin){
